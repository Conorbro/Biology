...
public class Database {
    ...
    public int getRowCount() throws SQLException{
        ...
        Cursor cursor = ourDatabase.rawQuery("SELECT * FROM QnA_table", null);
    ...
    static void addQuestions()
    {
        ...
        try{
            ...
            createEntry("Select the correct source for lipids",  "Butter, oil, meat, cheese", "Fruits", "Vegetables", "Vitamins minerals");
            ...
            createEntry("Biotic Factors are defined as...", "The influences of living organisms on each other", "The influence of the environment on organisms,", "The influence of organisms on the environment", "The influence of the environment on itself");
            ...
            createEntry("Mutualism is defined as...", "Two different organisms living together where both benefit", "Two different organisms living together where one (the parasite) benefits and causes the other (host) harm", "Two different organisms living together where one benefits and the other other is unharmed/harmed", "Relationship between two organisms where neither benefit");

            createEntry("Parasitism is defined as...","Two different organisms living together where one (the parasite) benefits and causes the other (host) harm", "Two different organisms living together where both benefit",  "Two different organisms living together where one benefits and the other other is unharmed/harmed", "Relationship between two organisms where neither benefit");

            createEntry("Commensalism is defined as...", "Two different organisms living together where one benefits and the other other is unharmed/harmed","Two different organisms living together where both benefit", "Two different organisms living together where one (the parasite) benefits and causes the other (host) harm",  "Relationship between two organisms where neither benefit");

            createEntry("Pollution is defined as...", "Any harmful addition to the environment", "Destruction of the environment by humans", "Phenomenon such as acid rain caused by humans", "Littering");

            createEntry("A Pollutant is...", "A substance that causes harm to the environment, e.g. Sulphur Dioxide SO2","Any harmful addition to the environment", "Destruction of the environment by humans", "Phenomenon such as acid rain caused by humans" );

            createEntry("Sulphur Dioxide pollution causes....", "Acid rain", "Smog", "Global warming", "Smoke Particles");
            ...
            createEntry("Conservation is defined as...", "A series of activities designed to preserve or protect the environment","Any means that prevents pollution of the environment", "The upkeep or organisms and their environment", "The preservation of an organism's environment" );
            ...
            createEntry("Problems of waste management include...", "Incinerators burn rubbish and harmful gases may be released", "Seagulls flock around landfill sites", "Landfill sites attract looters", "Hard to maintain");
            ...
            createEntry("Which Animal Kingdom are bacteria a part of?", "Monera", "Fungi", "Protoctista", "Animal");

            createEntry("Which Animal Kingdom are mushrooms a part of?", "Fungi", "Monera", "Animal", "Protoctista");

            createEntry("Which Animal Kingdom are amoebas a part of?", "Protoctista", "Monera", "Fungi", "Plant");

            createEntry("Which Animal Kingdom are buttercups a part of?", "Plant", "Monera", "Fungi", "Protoctista");

            createEntry("Which Animal Kingdom are rabbits a part of?", "Animal", "Monera", "Fungi", "Protoctista");

            createEntry("A qualitative survey...", "Records all species present in an ecosystem", "Measures the population size or distribution of a species", "Measures the size only of a species", "Records some species in an ecosystem");

            createEntry("A quantitative survey...","Measures the population size or distribution of a species", "Measures the size only of a species", "Records some species in an ecosystem", "Records all species present in an ecosystem");
            ...
            createEntry("An adaptation is...","A feature of an organism that suits it to its environment", "A decision made by the organism to suit its environment", "An environmental quirk tailored to a specific organism", "None of the above");

            createEntry("Which of the following is a valid example of an adaptation?", "Spider - uses its web to catch prey", "Snail - slime for enhanced mobility", "Daisy - bright colour to absorb sunlight", "Rabbit - big feet to kick predators");
            ...
            createEntry("The function(s) of the mitochondria are...","Aerobic respiration", "Protein synthesis","To support the cell and prevent bursting",   "Photosynthesis");

            createEntry("The function(s) of the nucleus are...","Hold DNA and to control the cell's activities", "Protein synthesis","To support the cell and prevent bursting",   "Photosynthesis");

            createEntry("Prokaryotic cells...", "Do not have a membrane-bound nucleus and organelles such as mitochondria and chloroplasts (Monera kingdom)", "Have a nucleus bounded by a membrane and mitochondria and chloroplasts", "None of the above", "Have no nucleus present in the cytoplasm");

            createEntry("Eukaryotic cells...", "Have a nucleus bounded by a membrane and mitochondria and chloroplasts","Do not have a membrane-bound nucleus and organelles such as mitochondria and chloroplasts (Monera kingdom",  "None of the above", "Have no nucleus present in the cytoplasm");

            createEntry("Tissue is defined as...", "A group of cells specialised for a particular function", "A group of different cells working together for a particular function(s)", "Part of an organ working together to carry out a particular function(s)","None of the above");

            createEntry("Organ is defined as...", "A group of different tissues working together for a particular function(s)","A group of cells specialised for a particular function",  "Part of an organ working together to carry out a particular function(s)","None of the above");
            ...
            createEntry("Which of the following is tissue culture NOT used for?", "Tanning", "Micro-propagation of plants", "Transplant surgery, e.g. skin grafting", "Cancer research");

            //4. Cell Continuity (15) (22) (95)

            createEntry("Cell continuity means...", "Existing cells divide and produce new cells", "Existing cells sustain themselves", "Existing cells move from place in an organism to another", "Existing cells reproduce with each other to form new cells");
            ...
            createEntry("The stages of mitosis are...", "Prophase, Metaphase, Anaphase, Telophase", "Metaphase, Anaphase, Telophase", "Prophase, Metaphase, Anaphase", "Prophase, Metaphase, Anaphase, Telophase, Metaphase");
            ...
            createEntry("The results) of meiosis are...", "Chromosome number halved + daughter nuclei genetically different",  "2 identical daughter cells + the chromosome number is kept constant", "2 identical daughter cells", "Chromosome number is kept constant");
            ...
            createEntry("Which of the following is not a cause of cancer?", "Jogging", "Cigarette smoke", "Asbestos", "Ultraviolet light");

            //Cell Membranes (7) (110)

            createEntry("Diffusion is defined as...", "The movement of molecules in a liquid or gas from a region of higher to lower concentration", "The movement of water molecules from a region of higher concentration to a region of lower concentration across a semipermeable membrane", "Shrinkage of plant cells due to loss of water by osmosis","The movement of molecules from an area of low concentration to an area of high concentration");

            createEntry("Osmosis is defined as...","The movement of water molecules from a region of higher concentration of water to a region of lower concentration across a semipermeable membrane", "The movement of molecules in a liquid or gas from a region of higher to lower concentration",  "Shrinkage of plant cells due to loss of water by osmosis","The movement of molecules from an area of low concentration to an area of high concentration");

            createEntry("Turgor is defined as...","A state in which a cell is fully stretched and rigid due to the cytoplasm pushing out against the restraining cell wall", "The movement of molecules in a liquid or gas from a region of higher to lower concentration",  "Shrinkage of plant cells due to loss of water by osmosis","The movement of molecules from an area of low concentration to an area of high concentration");

            createEntry("Plasmolysis is defined as...","Shrinkage of plant cells due to loss of water by osmosis","The movement of water molecules from a region of higher concentration of water to a region of lower concentration across a semipermeable membrane", "The movement of molecules in a liquid or gas from a region of higher to lower concentration",  "The movement of molecules from an area of low concentration to an area of high concentration");
            ...
            createEntry("Which of the following is NOT an example of osmosis?", "Absorption of food in the intestine", "Absorption of H2O in the intestine", "The opening and closing of the stoma", "Re-absorption of H2O in the nephron");
            ...
            createEntry("Enzymes are defined as...", "Biological catalysts produced by living cells (on the ribosomes)", "Cells for growing muscle tissue", "A type of lipid used by the body", "The byproducts of digestion");
            ...
            createEntry("An enzyme whose structure is permanently damaged and can no longer function is known as...", "A denatured enzyme", "A broken enzyme", "An enzyme", "None of the above");

            createEntry("Bioprocessing is defined as...", "The use of living organisms or their enzymes to produce useful substances", "The use of dead organisms to produce useful substances", "The use of denatured enzymes to produce useful substances", "The use of living organisms to produce denatured enzymes");
            ...
            createEntry("What is the method to immobilize enzymes?", "Gel beads containing enzymes are prepared using sodium alginate and calcium chloride solutions", "Hollow beads containing enzymes are prepared using sodium chloride solutions", "Empty gel beads are used to capture the enzymes floating free in the solution", "None of the above");
            ...
            createEntry("Immobilized enzymes are usually placed in a...","Bioreactor", "Tube", "Recyclable container", "Cardboard box");

            createEntry("Which of the following is an application of immobilised enzymes?", "Conversion of glucose to fructose using glucose isomerase", "None of the above", "Electrolysis", "Respiration and Photosynthesis");

            createEntry("Which of the following is NOT an advantage of immobilized enzymes?", "Enzymes can alter the thermodynamics of a reaction", "Immobilised enzymes are easily recovered", "They can be re-used and are therefore economical", "The product is easily separated and purified");

            createEntry("What does 'ATP' stand for?", "Adenosine Triphosphate", "Adenosine Triphosphate", "Alternative Triphosphate", "None of the above");
            ...
            createEntry("What does ADP stand for?", "Adenosine diphosphate", "Adenosine Triphosphate", "None of the above", "Adenosine diphosphate");
            ...
            createEntry("A nucleotide in DNA is made up of...", "Phosphate (P) + Deoxyribose (S) + Nitrogen base", "Phosphate (P) + Deoxyribose (S)", "Deoxyribose (S) + Nitrogen base", "Phosphate (S) + Nitrogen base");
            ...
            createEntry("In the complementary bases of DNA adenine is bonded to...","Thymine" , "Guanine", "Cytosine", "Adenine");

            createEntry("In the complementary bases of DNA guanine is bonded to..." , "Cytosine","Adenine","Thymine" , "Guanine" );

            createEntry("In the complementary bases of DNA cytosine is bonded to..." , "Guanine", "Cytosine","Adenine","Thymine"  );

            createEntry("A gene is defined as...", "A unit of hereditary information located on a chromosome and made of DNA", "A sequence of triplets that codes for the formation of protein", "Three bases in sequence in a DNA strand that codes for particular amino acid", "None of the above");

            createEntry("Genetic code is defined as...", "A sequence of triplets that codes for the formation of protein", "A unit of hereditary information located on a chromosome and made of DNA", "Three bases in sequence in a DNA strand that codes for particular amino acid", "None of the above");

            createEntry("A triplet code or codon is defined as...", "Three bases in sequence in a DNA strand that codes for particular amino acid","A sequence of triplets that codes for the formation of protein", "A unit of hereditary information located on a chromosome and made of DNA", "None of the above");
            ...
            createEntry("What bases does RNA consist of?","Adenine, uracil, guanine, cytosine", "Adenine","Adenine, guanine, cytosine, thymine", "Thymine, uracil, cytosine");
            ...
            createEntry("At what stage of the cell cycle does DNA replication take place?", "Interphase", "Prophase", "Anaphase", "Telophase");
            ...
            createEntry("DNA profiling is defined as...", "The making of a pattern of fragments of DNA for comparison", "Categorising nucleotides in a subject's DNA", "A stage of DNA replication", "The conversion of DNA to RNA");

            createEntry("Genetic screening is...", "The testing for the presence or absence of a particular gene(s)", "The making of a pattern of fragments of DNA for comparison", "Manipulation and alteration of genes or genotype", "A stage of DNA replication");

            createEntry("In DNA profiling, what is used to extract DNA from the cell?", "Restriction enzymes", "Bacteria", "RNA", "Phospholipids");

            createEntry("In DNA profiling, how are the extracted fragments separated?", "By size", "By colour", "By scent", "None of the above");
            ...
            createEntry("Name the two scientists who are associated with the theory of of evolution and natural selection", "Charles Darwin and Alfred Russel Wallace", "Albert Einstein and Isaac Newton", "Marie Curie and Gregor Mendel", "Max Born and Galileo Galilei");
            ...
            createEntry("In the theory of evolution, the struggle for existence is caused by competition for...", "Food, shelter, and a mate", "Food", "Food and shelter", "Shelter and a mate");
            ...
            createEntry("A genotype is defined as...", "The genetic makeup of an organism", "The differences between members of a species","The passing on of characteristics from parents to offspring", "The study of heredity and variation");
            ...
            //Classification of organisms/Viruses/Bacteria/Fungi (190)
            ...
            createEntry("Which of the following is NOT a nonliving feature of a virus", "All answers are valid", "Non-cellular", "No cell organelles", "Consist of only one nucleic acid (DNA or RNA) inside a protein coat");
            ...
            createEntry("Name a beneficial effect of viruses", "Formation of vaccines", "Polio and Aids", "Foot and mouth", "Tomato mosaic disease");
            ...
            createEntry("Endospores are...", "Resistant, thick-walled spores formed within the cell under adverse conditions", "Fragile, thick-walled spores formed within the cell under favourable conditions", "Fragile, thick-walled spores formed within the cell under adverse conditions", "None of the above");
            ...
            createEntry("Rhizopus is...", "A saprophytic fungus found on bread and other starchy foods", "A type of bacteria found in decaying organic matter", "A type of virus transferred via sexual intercourse", "None of the above");

            createEntry("Select the correct order of steps that occurs in the asexual reproduction of Rhizopus", "Sporangiophores grow upwards - sporangia form - spores formed by mitosis are released and dispersed - spores germinate forming new mycelia", "Sporangia form - spores formed by mitosis are released and dispersed - sporangiophores grow upwards - spores germinate forming new mycelia", "Spores germinate forming new mycelia - spores formed by mitosis are released and dispersed - sporangiophores grow upwards - sporangiophores grow upwards", "Spores formed by mitosis are released and dispersed - sporangiophores grow upwards - sporangiophores grow upwards");
            ...
            createEntry("Which of the following is an economic importance of fungi?", "Production of antibiotics, e.g. penicillin", "Ringworm", "Thrush", "Athlete's foot");

            createEntry("Which of the following is a harmful effect of fungal?", "Diseases in humans",  "Production of antibiotics", "Production of alcohol by yeast", "Bread making");

            createEntry("What is osmoregulation in amoeba?", "The maintenance of the H2O balance in the cytoplasm of the amoeba", "The maintenance of the O2 levels in the cytoplasm of the amoeba", "None of the above", "The consumption of H2O by an amoeba");

            //Flowering Plant Structure (221)

            createEntry("What are the functions of the roots?", "Anchor plant, absorb H2O & minerals, food storage", "Photosynthesis, transpiration, food storage", "Support leaves + flowers, transport of meniere's/food/H2O", "Sexual reproduction");

            createEntry("What are the functions of the stems?","Support leaves + flowers, transport of meniere's/food/H2O", "Anchor plant, absorb H2O & minerals, food storage", "Photosynthesis, transpiration, food storage",  "Sexual reproduction");

            createEntry("What are the functions of the leaves?", "Photosynthesis, transpiration, food storage", "Support leaves + flowers, transport of meniere's/food/H2O","Anchor plant, absorb H2O & minerals, food storage",  "Sexual reproduction");

            createEntry("What are the functions of the buds?", "Growth of main stem + side branches, formation of flowers, food storage", "Photosynthesis, transpiration, food storage", "Support leaves + flowers, transport of meniere's/food/H2O", "Sexual reproduction");

            createEntry("What are the functions of the flowers?", "Sexual reproduction", "Anchor plant, absorb H2O & minerals, food storage", "Photosynthesis, transpiration, food storage", "Support leaves + flowers, transport of meniere's/food/H2O");
            ...
            createEntry("What does phloem consist of?", "Sieve tubes and companion cells", "Epidermis", "Vascular tissue", "Xylem");
            ...
            createEntry("What adaptation do root hairs have to increase water absorption?", "Large surface area", "Small surface area", "Root hairs do not absorb water", "Short root hairs");
            ...
            createEntry("Give an example of a modified root that stores food in plants", "Tap root in carrots", "Stem tuber in potatoes", "Bulb in onions", "Chestnut in oak tree");

            createEntry("Give an example of a modified stem that stores food in plants", "Stem tuber in potatoes","Tap root in carrots",  "Bulb in onions", "Chestnut in oak tree");

            createEntry("Give an example of a modified leaf that stores food in plants", "Bulb in onions","Stem tuber in potatoes", "Tap root in carrots",   "Chestnut in oak tree");
            ...
            createEntry("In blood, plasma is...", "The liquid part of blood", "Colourless, nucleus containing cell that defends against disease" , "No nucleus, cell fragments that clot the blood", "Biconcave, haemoglobin containing, no nucleus or mitochondria cell that transports O2");

            createEntry("In blood, red blood cells are...", "Biconcave, haemoglobin containing, no nucleus or mitochondria cell that transports O2", "The liquid part of blood", "Colourless, nucleus containing cell that defends against disease" , "No nucleus, cell fragments that clot the blood");

            createEntry("In blood, white blood cells are...", "Colourless, nucleus containing cell that defends against disease" ,"Biconcave, haemoglobin containing, no nucleus or mitochondria cell that transports O2", "The liquid part of blood",  "No nucleus, cell fragments that clot the blood");

            createEntry("In blood, platelets are...",  "No nucleus, cell fragments that clot the blood", "Colourless, nucleus containing cell that defends against disease" ,"Biconcave, haemoglobin containing, no nucleus or mitochondria cell that transports O2", "The liquid part of blood");
            ...
            createEntry("What is pulse?","The wave of vibrations in arteries due to blood being forced out of the ventricles", "The force of blood pushing against the wall of a blood vessel",  "The oxygen in moving around in blood", "None of the above");
            ...
            createEntry("What is lymph?", "A colourless fluid formed from tissue fluid consisting of plasma and lymphocytes", "The force of blood pushing against the wall of a blood vessel", "The wave of vibrations in arteries due to blood being forced out of the ventricles", "The oxygen in moving around in blood");
            ...
            createEntry("What is the function of the gallbladder in digestive system?","Storage of bile", "Cuts, chews, and grinds food up into smaller pieces","Prevents food from entering the trachea", "Churns food");

            createEntry("What is the function of the ileum in the small intestine in digestive system?","Absorbs nutrients from food", "Cuts, chews, and grinds food up into smaller pieces","Prevents food from entering the trachea", "Churns food");
            ...
            createEntry("What is the role of fibre in the diet?", "Stimulates peristalsis", "Produces bile and heat", "Produces urea from the breakdown of excess amino acids", "Breaks down red blood cells and toxic chemicals taken from the blood");

            createEntry("Which of the following is NOT a function of the liver?", "Stimulates peristalsis", "Produces bile and heat", "Produces urea from the breakdown of excess amino acids", "Breaks down red blood cells and toxic chemicals taken from the blood");
            ...
            createEntry("What are/is the major function(s) of the kidneys?", "Excretion and Osmoregulation", "Excretion only", "Digestion", "Respiration and Osmoregulation");
            ...
            createEntry("What does ADH stand for?", "Antidiuretic hormone", "Anti-diarrhoea hormone", "Anti-deflamatory hormone", "Anti-death hormone");
            ...
            createEntry("What is the function of the larynx?", "Produces sound", "Carries air to lungs", "Gas exchange", "Contains mucus which traps dirt and bacteria, cilia that moves mucus up to the mouth and cartilage rings keep air tubes open");

            createEntry("What is the function of the larynx?", "Produces sound", "Carries air to lungs", "Gas exchange", "Contains mucus which traps dirt and bacteria, cilia that moves mucus up to the mouth and cartilage rings keep air tubes open");

            createEntry("What is the function of the trachea?","Contains mucus which traps dirt and bacteria, cilia that moves mucus up to the mouth and cartilage rings keep air tubes open", "Produces sound", "Carries air to lungs", "Gas exchange" );

            createEntry("What is the function of bronchus?","Carries air into the lungs","Contains mucus which traps dirt and bacteria, cilia that moves mucus up to the mouth and cartilage rings keep air tubes open", "Produces sound",  "Gas exchange" );

            createEntry("What is the function of the bronchioles?","Carries air to and from the alveoli", "Produces sound", "Carries air to lungs", "Gas exchange" );

            createEntry("What is the function of the alveoli?", "Gas exchange","Carries air to and from the alveoli", "Produces sound", "Carries air to lungs" );
            ...
            createEntry("Select the correct order of stages for inhalation in the mechanism of breathing ", "Intercostal muscles contract, rib-cage moves up and out, diaphragm contracts + flattens, volume of thorax increases, lung air pressure decreases, air flows into lungs", "Rib-cage moves up and out, diaphragm contracts + flattens, volume of thorax increases, lung air pressure decreases, air flows into lungs", "Diaphragm contracts + flattens, intercostal muscles contract, rib-cage moves up and out,  volume of thorax increases, lung air pressure decreases, air flows into lungs", "Rib-cage moves up and out, intercostal muscles contract, diaphragm contracts + flattens, volume of thorax increases, lung air pressure decreases, air flows into lungs");

            createEntry("Select the correct order of stages for exhalation in the mechanism of breathing", "Intercostal muscles relax, rib-cage goes down and in, diaphragm relaxes, thorax volume decreases, lung air pressure increases, air is forced out of lungs", "Rib-cage goes down and in, intercostal muscles relax,  diaphragm relaxes, thorax volume decreases, lung air pressure increases, air is forced out of lungs", "Intercostal muscles relax, rib-cage goes down and in, diaphragm relaxes, lung air pressure increases, thorax volume decreases,  air is forced out of lungs", "Rib-cage goes down and in, diaphragm relaxes, thorax volume decreases, lung air pressure increases, air is forced out of lungs, intercostal muscles relax");
            ...
            createEntry("What does the axial skeleton consist of?", "Skull, vertebrae(33), ribs(12), sternum", "Pectoral and pelvic girdles, arms and legs", "Cervical(7), thoracic(12), lumbar(5), sacrum(5), coccyx(4)", "None of the above");
            ...
            createEntry("What is the difference between osteoblasts and osteoclasts?", "Osteoblasts help make bone, osteoclasts help break down bone", "Osteoblasts help break down bone, osteoclasts help make bone", "There is no difference", "Osteoblasts are only found in human bone unlike osteoclasts which are found in all mammals");
            ...
            createEntry("What does the central nervous system consist of?", "The brain and spinal cord", "Cranial nerves and spinal nerves", "Brain only", "Spinal cord only");

            createEntry("What does the peripheral nervous system consist of?", "Cranial nerves and spinal nerves", "The brain and spinal cord",  "Brain only", "Spinal cord only");
            ...
            createEntry("What is a reflex action?", "An automatic response to a stimulus", "A conscious response to a stimulus", "A random response from the body to no stimulus", "A random response from the body to a stimulus");
            ...
            createEntry("Select the correct order of stages from the synapse mechanism of action", "Impulse arrives at synaptic knob, vesicles release neurotransmitter, neurotransmitter diffuses across the cleft, impulse generated in the next neuron, neurotransmitter broken down by an enzyme", "Impulse arrives at synaptic knob, vesicles release neurotransmitter, impulse generated in the next neuron, neurotransmitter diffuses across the cleft, neurotransmitter broken down by an enzyme", "Vesicles release neurotransmitter, impulse generated in the next neuron, impulse arrives at synaptic knob, neurotransmitter diffuses across the cleft, neurotransmitter broken down by an enzyme", "Impulse arrives at synaptic knob, vesicles release neurotransmitter, neurotransmitter broken down by an enzyme, impulse generated in the next neuron, neurotransmitter diffuses across the cleft");
            ...
            createEntry("What is the function of the eardrum in the ear?", "Transfers sound vibrations to bones", "Links middle ear to throat and keeps air pressure equal on both sides of the ear drum", "Transfers vibrations to the inner ear", "Hearing");
            ...
            createEntry("What is the function of the cochlea in the ear?", "Hearing", "Transfers sound vibrations to bones", "Links middle ear to throat and keeps air pressure equal on both sides of the ear drum", "Transfers vibrations to the inner ear");

            createEntry("What is the function of the oval window in the ear?","Transfers vibrations to the inner ear", "Transfers sound vibrations to bones", "Links middle ear to throat and keeps air pressure equal on both sides of the eardrum",  "Hearing");
            ...
            createEntry("What are the organs of the immune system?", "Spleen, thymus, lymph nodes", "Liver, spleen, lymph nodes", "Lymph nodes", "Spleen, thymus");

            createEntry("What is an antigen?", "A specific molecule that stimulates the formation of antibodies", "A defence protein produced by lymphocytes in response to recognising an antigen", "A small quantity of a dead pathogen that is stimulates the formation of antibodies and memory cells", "None of the above");

            createEntry("What is an antibody?", "A defence protein produced by lymphocytes in response to recognising an antigen","A specific molecule that stimulates the formation of antibodies",  "A small quantity of a dead pathogen that is stimulates the formation of antibodies and memory cells", "None of the above");

            createEntry("What is a vaccine?", "A small quantity of a dead pathogen that is stimulates the formation of antibodies and memory cells","A defence protein produced by lymphocytes in response to recognising an antigen","A specific molecule that stimulates the formation of antibodies",   "None of the above");
            ...
            createEntry("What are the different types of T cells?", "Helper T cells, Killer T cells, Suppressor T cells, Memory T cells", "Helper T cells, Killer T cells, Suppressor T cells", "Helper T cells, Killer T cells", "Helper T cells, Killer T cells, Suppressor T cells, Memory T cells, Sleeper T cells");

            createEntry("What is the function helper T cells?", "To recognise antigens and release chemicals that stimulate the production of B cells and killer T cells", "To destroy infected cells directly", "To stop the activity of B cells and T cells (stop the immune response)", "To remember antigen and give future resistance");
            ...
            createEntry("Where in the plant are growth regulators produced?", "The meristematic system", "Roots", "Flower", "Leaves");
            ...
            createEntry("what is the role of the uterus in the female reproductive system?", "Encloses the developing embryo", "Receives semen", "Produces eggs by meiosis and secretes oestrogen and progesterone", "None of the above");

            createEntry("what is the role of the vagina in the female reproductive system?", "Receives semen","Encloses the developing embryo",  "Produces eggs by meiosis and secretes oestrogen and progesterone", "None of the above");

            createEntry("what is the role of the ovaries in the female reproductive system?","Produces eggs by meiosis and secretes oestrogen and progesterone", "Encloses the developing embryo", "Receives semen",  "None of the above");

            createEntry("Which of the following is a secondary sexual characteristic in males?", "Deepening of voice", "Development of breasts", "Widening of the hips", "Production of breast milk");

            createEntry("Which of the following is a secondary sexual characteristic in females?","Widening of the hips", "Growth of facial hair", "Balls dropping", "Deepening of voice");

            createEntry("Select the correct order of stages of the menstrual cycle", "Graafian follicle develops in the ovary, Endometrium develops in the uterus, Ovulation occurs, Endometrium thickens, Corpus luteum breaks down in the ovary", "Endometrium develops in the uterus, Ovulation occurs, Graafian follicle develops in the ovary, Endometrium thickens, Corpus luteum breaks down in the ovary", "Graafian follicle develops in the ovary, Endometrium develops in the uterus, Endometrium thickens, Ovulation occurs, Corpus luteum breaks down in the ovary", "Graafian follicle develops in the ovary, Endometrium develops in the uterus, Corpus luteum breaks down in the ovary, Ovulation occurs, Endometrium thickens");

            createEntry("How many days does the menstrual cycle typically take place over?", "28 days", "10 days", "7 days", "42 days");
            ...
            createEntry("Which of the following is NOT a function of luteinising hormone (LH)?", "Maintains the thickening of the endometrium", "Stimulates ovulation", "Stimulates development of the corpus luteum from the Graafian follicle", "Stimulates the corpus luteum to secrete progesterone and oestrogen");

            createEntry("What happens hormonally if implantation does not occur?", "Levels of progesterone and oestrogen fall, pituitary gland secretes FSH - new cycle begins", "Levels of progesterone and oestrogen rise - new cycle begins", "Levels of progesterone rise, oestrogen levels fall - new cycle begins", "Levels of progesterone rise, oestrogen levels fall, FSH secretion from pituitary gland - new cycle begins");
            ...
            createEntry("How does pregnancy affect the menstrual cycle?", "It stops the menstrual cycle", "It accelerates the menstrual cycle", "It has no effect on the menstrual cycle", "It slows down the menstrual cycle");
            ...
            createEntry("Which of the following primary germ layers gives rise to the musculoskeletal and reproductive system?","Mesoderm", "Ectoderm",  "Endoderm", "None of the above");

            createEntry("Which of the following primary germ layers gives rise to the gut lining and liver?","Endoderm", "Ectoderm", "Mesoderm",  "None of the above");
            ...
            createEntry("What does oxytocin do?", "Stimulates contractions of the muscles of the uterus, cervix dilates and amnion bursts", "Causes ovulation and implantation to occur", "Stimulates fertilisation, causes amnion to burst", "Infertility in males");

            createEntry("Which hormone stimulates lactation?", "Prolactin", "Oxytocin", "LH", "FSH");

            createEntry("Which of the following is a benefit of breast-feeding?", "All answers are valid", "Provides baby with the correct nutrients", "Contains antibodies", "Helps the uterus to contract");
            ...
            createEntry("Name a disorder of the menstrual cycle", "Fibrosis", "Erectile dysfunction", "AIDS", "Asthma");

            createEntry("How can fibrosis be treated?", "Hormones and/or surgery", "Dieting", "Exercise", "It cannot be treated");

            createEntry("What causes fibrosis?", "Unknown cause - may be hormonal", "Poor diet", "Lack of exercise", "Uterus infections");



            //Sexual Reproduction in Flowering Plants (461)

            createEntry("What is pollination?", "The transfer of pollen from anther to stigma", "The transfer of pollen from stigma to anther", "Mitosis occurring in a plant", "Fertilisation");

            createEntry("What is self-pollination?", "When pollen grains are transferred onto the stigma of the same flower or onto another flower on the same plant", "When pollen grains are transferred onto the stigma of a flower on another plant of the same species", "Fertilisation", "None of the above");

            createEntry("What is cross-pollination?", "When pollen grains are transferred onto the stigma of a flower on another plant of the same species","When pollen grains are transferred onto the stigma of the same flower or onto another flower on the same plant",  "Fertilisation", "None of the above");
            ...
            createEntry("Select the correct order of stages for seed formation", "Post fertilisation, zygote forms seed embryo, endosperm nucleus forms endosperm, ovule develops into a seed/integuments form the testa, seed dries out, becomes dormant","Post fertilisation, endosperm nucleus forms endosperm, zygote forms seed embryo, ovule develops into a seed/integuments form the testa, seed dries out, becomes dormant","Post fertilisation, zygote forms seed embryo, ovule develops into a seed/integuments form the testa, endosperm nucleus forms endosperm, seed dries out, becomes dormant","Post fertilisation, zygote forms seed embryo, endosperm nucleus forms endosperm, seed dries out, becomes dormant, ovule develops into a seed/integuments form the testa");

            createEntry("What is the difference between endospermic seeds and non-endospermic seeds?", "Food is stored in the endosperm in endospermic seeds and is stored in the cotyledons in non-endospermic seeds", "Food is stored in the non-endosperm in endospermic seeds and is stored in the cotyledons in endospermic seeds", "There is no difference", "Endospermic seeds have no cotyledon whereas non-endospermic seeds do");

            createEntry("What is fruit?", "A mature ovary containing seeds", "Part of the roots responsible for water absorption", "Part of the leaves responsible for transpiration", "None of the above");

            createEntry("What are the functions of fruit?", "Seed protection and to disperse seeds away from the parent plant", "Water absorption and transport", "Transpiration", "Gas exchange");
            ...
            createEntry("What method of seed dispersal does a water-lily use?", "Water dispersal", "Mechanical/Self-dispersal", "Wind dispersal", "Animal dispersal");
